  ...
  <div class="relative z-10 max-w-3xl mx-auto py-24 px-6 flex flex-col items-center sm:items-start">
    <header class="flex flex-col items-center sm:items-start mb-16 w-full">
      <div class="relative mb-8">
        <div class="absolute inset-0 rounded-full bg-[#22c55e]/10 blur-2xl">
        </div>
        <img 
      ...
      <div class="text-gray-400 font-mono text-xs mt-4 flex flex-col items-center sm:items-start gap-2">
        <span class="flex items-center gap-2">
          <Terminal size={14} class="text-[#22c55e]" /> 
          Cybersecurity & Software Engineer
        </span>
        <span class="flex items-center gap-2 opacity-80">
          <Activity size={14} class="text-[#22c55e]" /> 
          YouTube Content Creator
        </span>
      </div>
      <div class="flex gap-6 mt-8">
        <a href="https://github.com/dincertekin" target="_blank" rel="noreferrer" class="text-gray-500 hover:text-[#22c55e] transition-colors">
          <Github size={20} />
        </a>
        <a href="https://youtube.com/@dincertekin" class="text-gray-500 hover:text-[#22c55e] transition-colors">
          <Youtube size={20} />
        </a>
        <a href="https://linkedin.com/in/dincertekin" class="text-gray-500 hover:text-[#22c55e] transition-colors">
          <Linkedin size={20} />
        </a>
      </div>
    </header>
    ...
    <section class="w-full mb-20">
      <div class="py-4 text-[11px] font-mono text-gray-500 uppercase tracking-[0.2em] flex items-center justify-center sm:justify-start gap-3 border-t border-white/5">
        <Code2 size={14} class="text-[#22c55e]" /> 
